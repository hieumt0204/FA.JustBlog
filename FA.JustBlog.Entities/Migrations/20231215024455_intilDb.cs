    ...
    public partial class intilDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Science", new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(833), "Delecius", new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(834), 1, "#" },
                    { 2, "Social", new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(836), "Delecius", new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(837), 1, "#" },
                    { 3, "Culture", new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(838), "Not good", new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(838), 1, "#" },
                    { 4, "Travel", new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(839), "Delecius", new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(840), 1, "#" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(730), new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(722), "Post content", new DateTime(2012, 12, 25, 1, 3, 12, 0, DateTimeKind.Unspecified), true, null, "mot", 1, "Title 1", null, "Url1", null },
                    { 2, 1, new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(734), new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(733), "employee", new DateTime(2021, 12, 25, 1, 3, 12, 0, DateTimeKind.Unspecified), true, null, "hai", 1, "Title 2", null, "Url12", null },
                    { 3, 2, new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(737), new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(736), "Name", new DateTime(2020, 12, 25, 1, 3, 12, 0, DateTimeKind.Unspecified), true, null, "ba", 1, "Title 3", null, "Url3", null },
                    { 4, 2, new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(739), new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(738), "gae", new DateTime(2016, 12, 25, 1, 3, 12, 0, DateTimeKind.Unspecified), false, null, "bon", 1, "Title 4", null, "Url4", null },
                    { 5, 1, new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(741), new DateTime(2023, 12, 15, 9, 44, 55, 325, DateTimeKind.Local).AddTicks(740), "Car", new DateTime(2015, 12, 25, 1, 3, 12, 0, DateTimeKind.Unspecified), true, null, "nam", 1, "Title 5", null, "Url5", null }
                });
